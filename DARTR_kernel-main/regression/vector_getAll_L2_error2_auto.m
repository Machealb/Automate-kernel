function [L2_err,L2rho_err,L2_errors,h]= vector_getAll_L2_error2_auto(cLcurveAll,rho_val,Ktrue,dx,plotOn,plot4paper)
...
name_str     = cLcurveAll.rkhsType;   % {'rkhs1','rkhs2','rkhs3','H1'};
